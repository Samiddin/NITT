...
const T = {
  uz: {
    ...
    admDocs: [
      "Pasport yoki tug'ilganlik haqida guvohnoma nusxasi",
      "9 yoki 11-sinf ta'lim hujjati (attestat)",
      "086-U shaklidagi tibbiy ma'lumotnoma",
      "3x4 o'lchamdagi 6 dona rangli fotosurat",
  ...
  ru: {
    ...
    admDocs: [
      ...
      "Документ об образовании за 9 или 11 класс (аттестат)",
      "Медицинская справка формы 086-У",
      "6 цветных фотографий размером 3x4",
  ...
  en: {
    ...
    admDocs: [
      ...
      "9th or 11th grade education certificate",
      "Medical certificate form 086-U",
      "6 color photographs sized 3x4",
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-slate-900/95 shadow-lg backdrop-blur" : "bg-slate-900/80 backdrop-blur"}`}>
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          <button onClick={() => go("home")} className="flex items-center gap-3 text-left">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 shadow-md">
